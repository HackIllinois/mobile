...
// TODO:
  ...
  // E2E Testing of the Scanning Functionality 
  // Modify Error and Success Modal UI
...
export default function QRScannerScreen() {
  ...
  const submitScanData = async (scannedData: string) => {
    ...
    try {
      ...
      const eventName = eventDetailsResponse.name;

      const response = await api.post<AxiosResponse<ScanSuccessData>>(
        '/event',
        {
          eventId: scannedData,
        }
            ...
            <View style={styles.modalContent}>
              {scanResult?.status === 'success' ? (
                <View style={styles.successContent}>
                  ...
                  <Text style={styles.pointsEarned}>{scanResult.pointsEarned || 0} pts have earned</Text>
                </View>
              ) : (
                <View>
